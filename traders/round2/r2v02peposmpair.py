# r2v02peposmpair.py: vNN counts only inside the `peposmpair` family (same round can have other r2v01… files with different tags).
    ...
    def run(self, state: TradingState):
        ...
        for product in self.PRODUCTS:
            ...
            if product == "INTARIAN_PEPPER_ROOT":
                ...
                slope = osmium_slope.slope
                if slope is not None and osmium_slope.n >= osmium_slope.warmup:
                    fair_value += slope * 500
