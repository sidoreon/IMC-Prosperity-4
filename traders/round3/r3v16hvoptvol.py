# r3v16hvoptvol.py: vNN counts only inside the `hvoptvol` family (same round can have other r3v01… files with different tags).
...
class Trader:
    ...
    VE_ANCHOR_WEIGHT = 0.5
    VE_EMA_ALPHA = 0.22
    VE_IMBALANCE_K = 5.5
    VE_IMBALANCE_CAP = 0.75
