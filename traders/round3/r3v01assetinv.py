# r3v01assetinv.py: vNN counts only inside the `assetinv` family (same round can have other r3v01… files with different tags).
# Cross-asset inventory.
#
