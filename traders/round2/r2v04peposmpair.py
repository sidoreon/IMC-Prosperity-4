# r2v04peposmpair.py: vNN counts only inside the `peposmpair` family (same round can have other r2v01… files with different tags).
...
class Trader:
    ...
    OSMIUM_EMA_ALPHA = 2.0 / 3.0
    OSMIUM_INV_SKEW = 0.030

    PEPPER_WARMUP_END = 1100
