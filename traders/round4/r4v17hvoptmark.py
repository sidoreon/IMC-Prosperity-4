# r4v17hvoptmark.py: vNN counts only inside the `hvoptmark` family (same round can have other r4v01… files with different tags).
...
class Trader:
    TARGET = "Mark 67"
    BASE_SIZE = 10
    ACTIVE = frozenset({"VELVETFRUIT_EXTRACT"})
