# r4v11hvoptmark.py: vNN counts only inside the `hvoptmark` family (same round can have other r4v01… files with different tags).
...
class Trader:
    # Be the counterparty the Mark has to hit: when Mark bought, we offer (sell) at touch next tick; when Mark sold, we b...
    TARGET = "Mark 01"
    BASE_SIZE = 8
    ACTIVE = frozenset(
        {
