# r0v04emerald.py: vNN counts only inside the `emerald` family (round 0; other families reuse v01 independently).
# Same take-then-make stack as r0v03emerald with higher position limits (75).
#
