# r4v14hvoptmark.py: vNN counts only inside the `hvoptmark` family (same round can have other r4v01… files with different tags).
...
class Trader:
    TARGET = "Mark 38"
    BASE_SIZE = 6
    ACTIVE = frozenset({"HYDROGEL_PACK", "VEV_4000"})
