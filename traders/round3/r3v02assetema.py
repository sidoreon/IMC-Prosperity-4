# r3v02assetema.py: vNN counts only inside the `assetema` family (same round can have other r3v01… files with different tags).
# Cross-asset EMA-style.
#
...
class Trader(_R3V23HvoptVolBase):
    ...
    def _trade_delta_one(
        ...
        try:
            ...
            return super()._trade_delta_one(product, depth, position, limit, data, fair)
        finally:
