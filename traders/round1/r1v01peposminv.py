# r1v01peposminv.py: vNN counts only inside the `peposminv` family (same round can have other r1v01… files with different tags).
...
class PepperRootStrategy:
    ...
    def run(self, product: str, order_depth: OrderDepth, position: int, market_trades: List) -> List[Order]:
