# r0v03emerald.py: vNN counts only inside the `emerald` family (round 0; other families reuse v01 independently).
# Take-then-make v2: stable emerald fair, EMA tomato with take pass then passive leg (limits 30/50).
#
