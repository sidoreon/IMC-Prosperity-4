# r0v02emerald.py: vNN counts only inside the `emerald` family (round 0; other families reuse v01 independently).
# Take-then-make: misprice takes then passive quotes; tomato EMA + momentum tilt (limits 20).
#
